...
namespace ChinookSystem.Entities
{
    ...
    //                      to indiciate primary key and key type
    ...
    internal class Artist
    {
        ...
        //an option on this annotation called GenerateDataBase(DataBaseGeneratedOption.xxxx)
        ...
        //None is used on a primary data that user Must supply

        [Key]
        public int ArtistId { get; set; }

        // [Required(ErrorMessage = "Name is required")]  not required because it is nullable
